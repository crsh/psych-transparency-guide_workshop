---
title: "<img src = 'images/open.png' style = 'margin-bottom: 45px;'/><br />Developing your personal workflow for transparent & reproducible research"
...
- Author and contributor to several R packages<br> (e.g., [`afex`](https://cran.r-project.org/web/packages/afex/index.html), [`citr`](https://cran.r-project.org/web/packages/citr/index.html), [`papaja`](https://github.com/crsh/papaja), [`prereg`](https://cran.r-project.org/web/packages/prereg/index.html), [`retractcheck`](https://cran.r-project.org/web/packages/retractcheck/index.html))
...
---
.pull-right-25[![:scale 80%](images/breuer.jpg)]

# About us
## Johannes Breuer

- PhD in psychology, University of Cologne<br />(media psychology)
- senior researcher at [GESIS &ndash; Leibniz Institute for the Social Sciences](https://www.gesis.org/en/home/) (Data Archive for the Social Sciences)
- Previously worked at different comm and psych departments & research projects investigating the use and effects of digital media
...
- _How_ can you share?
    ...
    - Licenses
<!-- -- -->
<!-- - How can you promote openness? -->


???
We try to make it an active workshop
Questions?
...
<!-- - It's just documenting your work -->
...
<!--     - Colleagues can scrutinize and build on your work -->
...
<!-- > &mdash;Jon Tennant, Imperial College London -->
...
<!-- > .highlight[Although I was committed to open data, I was not implementing it [...] It was a pain] to document the data;  [...] to format the data;  [...] to contact the library personnel;  [...] to figure out which data were indeed published as part of which experiments. [...] .highlight[I had neither a routine nor any daily incentive to archive data] (p. 1063, [Rouder, 2016](https://doi.org/10.3758/s13428-015-0630-z)) -->
...
---
.title-image[![:scale 65%](images/recommendation.png)]
...
???
Amnesia: Ask a colleague who was not involved with the project
...
<!-- - Can we judge a person's IQ from their face? -->
...
<!-- .center[ -->
<!-- ![:scale 10%](material/example-project/stimuli/CF0014_1100_NE.jpg) -->
<!-- ![:scale 10%](material/example-project/stimuli/CF0025_1100_NE.jpg) -->
<!-- ![:scale 10%](material/example-project/stimuli/CF00018_1100_NE.jpg) -->
<!-- ![:scale 10%](material/example-project/stimuli/CM0029_1100_NE.jpg) -->
<!-- ![:scale 10%](material/example-project/stimuli/CM0009_1100_NE.jpg) -->
<!-- ![:scale 10%](material/example-project/stimuli/CM0039_1100_NE.jpg) -->
<!-- ] -->
...
<!-- ??? -->
<!-- Exercise: Explore example project files -->


---
# What can you share?

.center[![:scale 70%](images/klein-et-al-figure-1.png)]

<div class = "reference"><center>Reprinted from <a href = "http://doi.org/10.1525/collabra.158">Klein et al., 2018</a> (<a href="https://creativecommons.org/licenses/by/4.0/">CC-BY Attribution 4.0</a>)</center></div>


---
.title-image[![:scale 70%](images/protocol.png)]
...
???
More detailed than published description

OBS recording: https://osf.io/eyfxs/


---
.title-image[![:scale 70%](images/material.png)]
...
--
    ...
    - Questionnaires
    - Stimulus material
    - Experimental software to present stimuli and collect responses
...
???
More on intellectual property rights later


<!-- Johannes -->

---
.title-image[![:scale 70%](images/data.png)]
...
.center[
<blockquote class="twitter-tweet" data-lang="en"><p lang="en" dir="ltr">Eternal hell and damnation to people who put tables in pdf format with formatting as Supplementary Data, without a csv/excel version.</p>&mdash; Dr Dutchy McDutchFace (@dutchscientist) <a href="https://twitter.com/dutchscientist/status/898938100008845313?ref_src=twsrc%5Etfw">August 19, 2017</a></blockquote>
<script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>

![](images/fire.png) ![](images/fire.png) ![](images/fire.png) ![](images/fire.png) ![](images/fire.png)
]

???
Mention informed consent templates
...
- Processed data
    ...
    - Ideally "Tidy Data" ([Wickham, 2014 ](https://www.jstatsoft.org/index.php/jss/article/view/v059i10/v59i10.pdf))
        ...
        4. Multiple tables should include a column that allows them to be linked.

<!-- .center[![](images/gather.png)] -->
...
---
.title-image[![:scale 70%](images/privacy.png)]
...
--
    ...
    - Data are personal if attributable to a specific person (using additional datasets if necessary)
    - The EU offers a [Guide to GDPR compliance](https://gdpr.eu/)

???
NB: We are no lawyers, so everything we say in this section is our own interpretation and should be taken with a grain of salt. When in doubt, you should consult with a legal expert.
...
> .highlight[To determine whether a natural person is identifiable, account should be taken of all the means reasonably likely to be used], such as singling out, either by the controller or by another person to identify the natural person directly or indirectly.

--

> .highlight[To ascertain whether means are reasonably likely to be used to identify the natural person, account should be taken of all objective factors, such as the costs of and the amount of time required for identification], taking into consideration the available technology at the time of the processing and technological developments. (Recital 26 EU GDPR)
...
<!-- ??? -->
<!-- What's potentially problematic in this dataset? -->
...
- Get informed consent and be specific about how you handle the data (e.g., Who will have access to the data how and for what purpose?)
--
...
- Control access to sensitive data
    - some repositories offer options for secure (onsite or remote) access
<!-- - _Only share anonymized data publicly_, e.g., -->
- Delete directly identifying information (e.g., full name, address, face, handwriting, date of birth)
- Mind combinations of indirect identifiers (e.g., ZIP code, gender, date of birth, [Sweeney, 2000](https://dataprivacylab.org/projects/identifiability/paper1.pdf))

.center[![:scale 35%](images/sweeney.png)]
...
- Check or remove free text entries and alter them when citing in publications
--
...
- If necessary, transform data, e.g.,
    ...
    - Aggregation
--
- For complex and high-risk data, use anonymization tools (e.g., [ARX](http://arx.deidentifier.org/), [Amnesia](https://amnesia.openaire.eu/index.html))
...
--
    - Units of measurement, coding of values (incl. missings), possible options or range
    - How a variable was derived from other variables
    
$$\mathrm{BMI} = \frac{m}{l^2}$$

???
Show simple codebook from example project: https://osf.io/rv7py/

Metadata can be provided/available at study and variable level

Some repositories use structured metadata formats (e.g., DDI which esp. common in the social sciences)
...
--
- If reuse value is high, consider a standardized, machine-readable format (e.g., [DDI](https://www.ddialliance.org/))
    - Some repositories provide implementation as a service

???
Codebook app: https://rubenarslan.ocpu.io/codebook/www/

Show SPSS (on website) and R codebook

makeCodebook() function from dataMaid package

codebook() function from the memisc package


<!-- Frederik

<!-- --- -->
<!-- .title-image[![:scale 70%](images/analysis.png)] -->
...
<!-- Exercise: Let participants draft some SOP for data analysis -->
...
- How to move from raw data to reported results
...
--
    - Analysis syntax
        ...
        - Write reports as dynamic documents (e.g., R package [`papaja`](https://github.com/crsh/papaja))
--
    - Set and record seeds for pseudo-random number generators


???
incl. data cleaning and transformation; show [supplementary material](http://psych-transparency-guide.uni-koeln.de/analytic-reproducibility.html#set-and-record-seeds-for-pseudorandom-number-generators) of Klein et al., 2018
...
---
.title-image[![:scale 70%](images/report.png)]
...
.center[![:scale 60%](images/pre-post-print.png)]

<div class="reference"><center>Reprinted from <a href="http://www.saa.org/Portals/0/SAA_Record_Sept_2017_Final_LR.pdf#page=10">Marwick et al., 2017</a> (<a href="https://creativecommons.org/licenses/by/4.0/">CC-BY Attribution 4.0 International</a>)</center></div>
...
- Gold open access
    - Published article
    - [Fair Open Access](https://www.fairopenaccess.org/)
    - [Free Journal Network](https://freejournals.org/current-member-journals/)
...
> any time is better than never  (p. 4, [Klein et al., 2018](https://doi.org/10.1525/collabra.158)).

.center[![:scale 85%](images/klein-et-al-figure-2.png)]

<div class = "reference"><center>Reprinted from <a href = "https://doi.org/10.1525/collabra.158">Klein et al., 2018</a> (<a href="https://creativecommons.org/licenses/by/4.0/">CC-BY Attribution 4.0</a>)</center></div>
...
- Have a _basic_ data management plan (DMP), ideally before starting a project
    ...
    - Simplifies addressing legal and ethical issues (e.g., informed consent)
- Consider sharing when choosing study materials
    - Open source tools
    - Material licenses
...
<!-- Show https://github.com/methexp/rawdata -->
...
- Research report (i.e., "preprint")
    - Fast dissemination of results
        - Citation advantage (e.g., [Piwowar & Vision, 2013](https://peerj.com/articles/175/))
    - Public peer review
...
- Develop a default project file structure, e.g.,
    - Klein et al. (2018) [example project](https://osf.io/rpydu/) and<br />[ready-to-fork OSF template](https://osf.io/ep26s/)
        - Study protocol
        - Materials
        - Raw data
        - Processed data
        ...
        - Research report
<!-- -- -->
<!-- - If necessary, control access (e.g., [OSF components](http://help.osf.io/m/projects/l/481998-create-components)) -->
...
Exercise: Fork OSF repo and upload workshop files
...
- Self-deposit vs. curated repositories
- [FAIR Data Principles](https://www.force11.org/group/fairgroup/fairprinciples) ([Wilkinson et al., 2016](https://doi.org/10.1038/sdata.2016.18))
...
- Recommendation: Choose a suitable publicly accessible repository that ideally (has)...
...
--
    5. Features access controls (e.g., limit access to a specified set/type of users)
    4. Supports systematic licensing
    6. Supports structured metadata
--
...
<!-- ??? -->
<!-- Demonstration: showcase good preregistrations (https://osf.io/h9k8n/) -->


<!-- --- -->
<!-- .title-image[![:scale 70%](images/software.png)] -->

<!-- # Specialized approaches -->

<!-- - Analysis scripts and software -->
<!--     - Hosted Version Control Systems (e.g., [GitHub](https://github.com/)) -->
...
<!--         - Additionally, archive in public repository -->


<!-- ??? -->
<!-- Demonstrate CodeOcean: https://codeocean.com/2018/06/13/contact-hypothesis-reevaluated/ -->
<!-- Demonstrate Pavlovia: https://pavlovia.org/explore -->
...
<!--     - Preprint repositories (e.g., [PsyArXiv](https://psyarxiv.com/), [BioRxiv](https://www.biorxiv.org/), [PeerJ](https://peerj.com/preprints-search/)) -->
...
<!-- - integrates with OSF -->
<!-- - prefered repository of APA -->


<!-- Johannes -->

---
.title-image[![:scale 70%](images/licenses.png)]

# Licenses

- Licenses define conditions of use and redistribution
    - Specified by copyright holder
- Many repositories (also) offer different access categories
- Access categories define who can access the research prodcuts (and how)
    - Specified by copyright holder or repository
...
- Factual information are usually *not* protected by copyright
    ...
    - Database structures and compilations of data can be copyrightable
...
> .highlight[The selection, coordination, and arrangement of the database is subject to copyright if it is sufficiently original. [...] The data or other contents contained in the database are subject to copyright if they are sufficiently creative.] Original poems contained in a database would be protected by copyright, but purely factual data (such as gene names or city populations) would not. .highlight[Facts are not subject to copyright], nor are the ideas underlying copyrighted content ([Creative Commons, 2018](https://wiki.creativecommons.org/wiki/Data)).
...
- Copyright holder may assign licenses
    - Standardized scales may be owned by publisher
    - Copyright to long verbatim free text responses may belong to participants
--
...
--
- Use easy-to-understand stanard licenses (e.g., [Creative Commons](https://creativecommons.org/licenses/))
    - README: "All files in this repository are licensed under a Creative Commons Zero License (CC0 1.0)"
--
- Use most permissive license possible (e.g., CC0, CC-BY)


---
.title-image[![:scale 70%](images/licenses-cc.png)]

# Creative Commons Licenses

- Modular general purpose license "building set"
    - In practice, seven combinations are supported
...
.center[![:scale 35%](images/cc-license-spectrum.png)]

<div class = "reference"><center>graphic by Shaddim, <a href="https://creativecommons.org/licenses/by/4.0/">CC-BY Attribution 4.0 International</a><br />original CC license symbols by Creative Commons, <a href="https://creativecommons.org/licenses/by/4.0/">CC-BY Attribution 4.0</a></center></div>
...
<!--     - Transparent research practices in theses, e.g., -->
<!--         - "Safe" transparency for capstone project (OSF group) -->
...
<!-- - Data Sharing & FAIR Data Short Course at the [GESIS Summer School](https://training.gesis.org/?site=pDetails&child=full&pID=0xB455C10E4BA7451CBC729596CA4A2F4C&subID=0x46AC3A06211E4932A8FF77D60B2A6A30&lang=en_US) -->
