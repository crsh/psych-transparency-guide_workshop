...
--
- For data with high reuse value, consider using a standardized and machine-readable format (e.g., [DDI](https://www.ddialliance.org/)) `r recommendation`
...
???
Show CodeOcean example: https://codeocean.com/2018/06/13/contact-hypothesis-reevaluated/
...
- Resources comparing repositories
    ...
    - APS Observer article by [DeSoto, 2016](https://www.psychologicalscience.org/observer/finding-a-home-for-your-science)
...
- Analysis scripts and software
    ...
    - Cloud-based analysis platforms (e.g., [Code Ocean](https://codeocean.com/))
...
- Use easy-to-understand standard licenses (e.g., [Creative Commons](https://creativecommons.org/licenses/) `r recommendation`, [Open data commons](https://opendatacommons.org/licenses/))
    - For example, "All files in this repository are licensed under a Creative Commons Zero License (CC0 1.0)"
--
