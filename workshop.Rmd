...
- Mind combinations of indirect identifiers (e.g., ZIP code, gender, DOB, [Sweeney, 2000](https://dataprivacylab.org/projects/identifiability/paper1.pdf))
...
- Dataset, e.g.,
    ...
    - Units of measurement, coding of values (e.g., "1 = Female","2 = Male"), possible options or range (e.g., “1 = not at all to 7 = Very much”)
    - Value(s) used for missing data
    - How a variable was derived from other variables (e.g., "`bmi` was derived from body weight `m` and height `l` as $\mathrm{BMI} = \frac{m}{l^2}$.")
...
- Resources for choosing a repository
