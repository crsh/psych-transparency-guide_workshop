...
--
    - Units of measurement, coding of values, possible options or range
...
--
- If reuse value is high, consider standardized, machine-readable format (e.g., [DDI](https://www.ddialliance.org/))
    - Some repositories provide implementation as a service

???
Codebook app: https://opencpu2.psych.bio.uni-goettingen.de/ocpu/user/rarslan/library/codebook/www/
...
- Choose a suitable publicly accessible repository
...
Exercise: Write preregistration with https://aspredicted.org/ for example project
...
- Public availability does not authorize to reuse
    ...
    - Access categories vs. licenses
        - Repositories may have different access categories (e.g., [GESIS DBK access categories](https://dbk.gesis.org/DBKSearch/LegendAC.htm))
--
