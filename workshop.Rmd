...
- Get informed consent and be as specific as possible about how you handle the data (e.g.: For what purpose do you collect the data? Who will have access to the data and how?)
--
...
- Licenses define conditions of (re)use and (re)distribution
    - specified by the data provider <!-- copyright holder? -->
- Many repositories (also) offer different access categories
- Access categories define who can access the data (and how)
    - specified by data provider or repository <!-- copyright holder? -->
