...
<img src="images/tidy_data.png" width="100%">
...
???
incl. data cleaning and transformation; see [supplementary material](http://psych-transparency-guide.uni-koeln.de/analytic-reproducibility.html#set-and-record-seeds-for-pseudorandom-number-generators) of Klein et al., 2018
...
- Licenses define conditions of (re)use
...
- Access categories define who can access the data (and how)
    - specified by data provider or repository
...
- Copyright owners may assign licenses
...
--
- Use easy-to-understand standard licenses (e.g., [Creative Commons](https://creativecommons.org/licenses/))
