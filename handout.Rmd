...
- Research report (see Figure\ \@ref(fig:pre-post-print))
    - Fast dissemination of results (citation advantage)
    - Public peer review
...
- Choose a suitable public repository (e.g., [Registry of Research Data Repositories](https://www.re3data.org/), [Meyer, 2018](http://journals.sagepub.com/doi/abs/10.1177/2515245917747656?journalCode=ampa), also see Table\ \@ref(tab:sharing-option-ratings))
...
- Use most permissive license possible (e.g., CC0 and ODC-PDDL)
    - Condition reuse only on attribution (e.g., CC-BY and ODC-BY)
