...
- When to share?
    ...
    - Show some preregistration websites, show case good preregistrations (https://osf.io/h9k8n/)
...
---
Workshop outline for *`r metadata$title`*, ESCON 2018, Cologne, Germany, `r metadata$date`.

Frederik Aust ([frederik.aust@uni-koeln.de](mailto:frederik.aust@uni-koeln.de), [\@frederikaust](http://twitter.com/frederikaust)); Johannes Breuer ([johannes.breuer@gesis.org](mailto:johannes.breuer@gesis.org))
